            ...
            if ($_FILES['image']['size']<=$taillemax)
            {
                ...
                if(in_array($extensionUpload,$extensionsValides)){
                    ...
                    if($resultat)
                    {
                        ...
                        $histAJOUT = $bdd->prepare("INSERT INTO historique(user,modification,date) VALUES (?,?,?)") ;
                        $histAJOUT->execute(array($_SESSION['user'],"ajout de l'etudiant de CIN: ".$CIN,date('d-m-y h:i:s') ));
