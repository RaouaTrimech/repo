            ...
            if ($_FILES['image']['size'] <= $taillemax) {
                ...
                if (in_array($extensionUpload, $extensionsValides)) {
                    ...
                    if ($resultat) {
                        ...
                        $histModif = $bdd->prepare("INSERT INTO historique(user,modification,date) VALUES (?,?,?)") ;
                        $histModif->execute(array($_SESSION['user'],"modification de l'etudiant de CIN: ".$_GET['edit'],date('d-m-y h:i:s') ));
